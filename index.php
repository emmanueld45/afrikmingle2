...
<head>
  <style>
    ...
    @media only screen and (max-width: 690px) {
      ...
      .signup-btn {
        width: 80%;
        padding: 15px;
        background: linear-gradient(45deg, crimson, darkblue);
        color: white;
        border: none;
        border-radius: 4px;
      }
  ...
  <meta charset="utf-8">
  <title>Afrik Mingle - Africa's online dating site</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto"><img src="icons/chaticon2.png" style="width:40px;height:40px;position:relative;top:-10px;"><span style="font-size:17px !important;"> Afrik<span style="color:lightblue;">Mingle</span></span></a></h1>
  ...
  ============================-->
  <section id="intro">
    <a href="login.php"><button style="position: absolute; top:5px;right:5px;background-color:rgba(0, 0, 0, 0);color:white;border:none;padding: 5px;z-index:1000;"><u>Login</u></button></a>
    <div class="intro-text">
      <h2>Africa's growing Dating site <i class="fa fa-heart" style="color:lightblue;"></i></h2>
      <p>we are here to make love happen faster</p>
      <span style="color:white;background-color: orange !important;color:black !important;border:2px solid black !important;" class="btn-get-started scrollto join-btn">Join now for FREE</span>
      <!--  <a href="howitworks.php" style="color:white;background-color: !important;color:white !important;border:2px solid white !important;" class="btn-get-started scrollto">How it works</a>
  -->
    </div>
    <!--
    <div class="product-screens">
      ...
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="img/myimg1.jpg" alt="" style="width:70%;height:auto;">
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="img/myimg2.jpg" alt="" style="width:70%;height:auto;">
      </div>
...
-->
  ...
  <main id="main">
    ...
    <div class="form-container">
      ...
      <div style="width:100%;text-align:center;font-weight:bold;font-size:20px;padding:10px;color:royalblue;opacity:0.8;">Signup for FREE!</div>
      <form action="signup1-check.php" method="POST" onsubmit="return validateForm()">
        <br>
        <div style="width:100%;display:flex;justify-content:center;">
          <span class="male-btn">Male</span>
          <span class="female-btn">Female</span>
          <input type="text" class="gender" name="gender" style="display:none;">
        </div>
        <br>
        <div style="width:100%;display:flex;justify-content:center;">
          <div style="width:45%;padding:5px;font-size:14px;font-weight:600;">Firstname</div>
          <div style="width:45%;padding:5px;font-size:14px;font-weight:600;">Lastname</div>
        </div>
        <div style="width:100%;display:flex;justify-content:center;margin-bottom:15px;">
          <input type="text" class="firstname" name="firstname" placeholder="">
          <input type="text" class="lastname" name="lastname" placeholder="">
        </div>


        <div style="padding-left:10px;font-size:14px;font-weight:600;">Email</div>
        <div style="padding:10px;margin-bottom:0px;">
          <input type="text" class="email" name="email" placeholder="">
        </div>

        <div style="padding-left:10px;font-size:14px;font-weight:600;">Password</div>
        <div style="padding:10px;">
          <input type="text" class="password" name="password" placeholder="">
        </div>
        <br>
        <div style="width:100%;display:flex;justify-content:center;">
          <input type="submit" class="signup-btn" name="signup1" value="START DATING">
        </div>
        <br>
      </form>

      <div style="width:100%;padding:10px;text-align:center;">Already a member? <a href="login.php" style="color:royalblue;"><u>Login here</u></a></div>
    </div>

    <!-- start of error box -->
    <div class="error-box">
      <span class="error-message">error, please fill email address</span>
    </div>
    <!-- end of error box -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <!--img src="img/myimg4.jpg" alt="" class="wow fadeInLeft">--
          </div>
          ...
          <div class="col-lg-8 col-md-7 ">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 box wow fadeInRight">
                <div class="icon" style="color:navy !important;"><i class="ion-ios-speedometer-outline"></i></div>
              ...
              <div class="col-lg-6 col-md-6 box wow fadeInRight" data-wow-delay="0.1s">
                ...
                <h4 class="title"><a href="">Get Matched</a></h4>
              ...
              <div class="col-lg-6 col-md-6 box wow fadeInRight" data-wow-delay="0.2s">
                ...
                <h4 class="title"><a href="">Start a conversation</a></h4>
              ...
              <div class="col-lg-6 col-md-6 box wow fadeInRight" data-wow-delay="0.3s">
                ...
                <h4 class="title"><a href="">End up satisfied</a></h4>
  ...
  <script>
    ...
    function validateForm() {
      ...
      if (gender == "") {
        ...
        $(".error-message").html("error, <b>gender</b> must be selected");
        return false;
      } else if (firstname == "") {
        ...
        $(".error-message").html("error, <b>firstname</b> must be filled");
        return false;
      } else if (lastname == "") {
        ...
        $(".error-message").html("error, <b>lastname</b> must be filled");
        return false;
      } else if (email == "") {
        ...
        $(".error-message").html("error, <b>email</b> must be filled");
        return false;
      } else if (password == "") {
        ...
        $(".error-message").html("error, <b>password</b> must be filled");
        return false;
      } else {
        $(".signup-btn").val("Please wait..").css("font-weight", "bold");
        return true;
      }
  ...
  <script>
    ...
    OneSignal.push(function() {
      OneSignal.init({
        appId: "a956e255-033d-4a12-a3c4-acb078d35b25",
      });
    });
  </script>
